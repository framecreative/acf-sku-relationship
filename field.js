...
(function($) {
  ...
  acf.fields.sku_relationship = acf.field.extend({
    type: 'sku_relationship',
    ...
    focus: function() {
      // get elements
      this.$el = this.$field.find('.acf-sku_relationship');
...
*/
    ...
    fetch: function() {
      ...
      // add to this.o
      this.o.action = 'acf/fields/sku_relationship/query';
      ...
      this.$choices
        .children('.list')
        .append('<p>' + acf._e('relationship', 'loading') + '...</p>');
